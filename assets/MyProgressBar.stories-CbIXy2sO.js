...
- Los estilos de Material UI pueden personalizarse mediante la prop \`sx\` en \`Box\` o \`LinearProgress\`.`,methods:[],displayName:"MyProgressBar",props:{progress:{required:!0,tsType:{name:"number"},description:""}}};const b={title:"Components/MyProgressBar",component:c,argTypes:{progress:{control:{type:"number",min:0,max:100},description:"Porcentaje de progreso (0 a 100).",defaultValue:0}}},o={args:{progress:100}},s={args:{progress:1}};var a,t,i;o.parameters={...o.parameters,docs:{...(a=o.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
...
}`,...(l=(d=s.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const B=["FullProgress","InitProgress"];export{o as FullProgress,s as InitProgress,B as __namedExportsOrder,b as default};
